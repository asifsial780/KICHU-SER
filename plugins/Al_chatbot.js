...
if (conf.LANG == 'TR') {
    ...
    already_on = 'KICHU-SER yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'KICHU-SER yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'KICHU-SER, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'KICHU-SER, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Turns on AI powered chatbot on to your account!'
    already_on = 'Amalaer chatbot is already on.'
    already_off = 'KICHU-SER chatbot is currently turned off!.'
    succ_on = 'KICHU-SER chatbot on! Restarting to make chatbot ✅'
    succ_off = 'KICHU-SER chatbot off Restarting to make normal  ❤️'
}
if (conf.LANG == 'ML') {
    fulleva_dsc = 'പൂർണ്ണമായും പ്രവർത്തനക്ഷമമായ KICHU-SER chatbot സജീവമാക്കുന്നു. നിങ്ങളുടെ അക്കൗണ്ട് ഒരു ചാറ്റ്ബോട്ടാക്കി മാറ്റുക!'
    already_on = 'കൃത്രിമബുദ്ധി ഇതിനകം പൂർണ്ണമായി പ്രവർത്തിക്കുന്നു.'
    already_off = 'AI നിലവിൽ സെമി-ഫംഗ്ഷണൽ ആണ്.'
    succ_on = 'KICHU-SER പൂർണ്ണമായും പ്രവർത്തനക്ഷമമായി തുറന്നു! കുറച്ച് കാത്തിരിക്കൂ! ✅'
    succ_off = 'KICHU-SER സെമി-ഫങ്ഷണൽ ആയി സജ്ജമാക്കുക! കുറച്ച് കാത്തിരിക്കൂ! ☑️'
}

New.addCommand({ pattern: 'kichuser ?(.*)', desc: _dsc, fromMe: true,dontAddCommandList: true, usage: '.kichuser on / off' }, (async (message, match) => {
