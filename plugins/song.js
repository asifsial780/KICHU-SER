...
r_text[1] = "kichune tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Kichu says onnula poda😌";
r_text[3] = "Kichune oralku koduthekkuvann!";
r_text[4] = "hi, how are you";
r_text[5] = "njan pani eduth maduth ennikk korch rest theroo...🥵🥵";
r_text[6] = "Kichu - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Kichu,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its kichuser 😌";
...
r_text[13] = ".song adich thangalude fav song name para kichu ser ath download aakki tharum";
...
r_text[18] = "enikk thakku und thakku uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe kichu pazhaya kichu thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik anne it's me kichuser";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. Kichu";
r_text[24] = "\nVarrierey… Enthado njan inganey aayi poyathu\n";
r_text[25] = "\nPempillerey roattikoodey nadakkaan nee sammathikkilla, alley?... Da, neeyaanee alavaladi Makry alley\n";
