...
Asena.addCommand({pattern: 'yt ?(.*)', fromMe: false, desc: 'play song' , dontAddCommandList: true }, async (message, match) => {
	
	await message.client.sendMessage(message.jid, '```Hey Mwonu Wait!```' , MessageType.text, { quoted: message.data });
