...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'Kichu' : process.env.OWNER_NAME,
    PHONE: process.env.NUMBER === undefined ? '+918714183251' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'Kichuser' : process.env.DEPLOYER,
    ...
    MENTION: process.env.TAG_REPLY === undefined ? '918714183251@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? 'ᛕ꠸ᥴꫝꪊֆꫀʀ🥵✨' : process.env.BOT_NAME,
    ...
    YAK: process.env.YAK === undefined ? '918714183251,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
